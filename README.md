# Portfolio — Luke Dowling

<!-- Tech badges -->

[![React](https://img.shields.io/badge/React-19.0-blue?logo=react&logoColor=white)](https://react.dev)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0-blue?logo=typescript&logoColor=white)](https://www.typescriptlang.org)
[![Vite](https://img.shields.io/badge/Vite-7.0-brightgreen?logo=vite&logoColor=white)](https://vitejs.dev)
...
- Fast development and optimized production builds with Vite 7.
- Modern UX: accessible, responsive design, dark/light themes and smooth page transitions.
- Utility-first styling with Tailwind CSS v4.
- Contact form with validation powered by React Hook Form, Zod, and EmailJS.
